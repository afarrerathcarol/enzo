...
int SetDefaultGlobalValues(TopGridData &MetaData)
{
  ...
  */
  ...
  PopIIIInitialMassFunctionSub     = 0;
  ...
  PopIIIStellarFeedbackDistRadius  = 0;
  PopIIIStellarFeedbackDistCellStep = 0;
  PopIIIStellarFeedbackDistTotalCells = 1;
  PopIIISimpleSupernovaDistRadius  = 0;
  PopIIISimpleSupernovaDistCellStep = 0;
  PopIIISimpleSupernovaDistTotalCells = 1;
  PopIIIEnergyToThermalFeedback     = 1.e-5;
  PopIIIMakerMassEfficiency        = 5.e-2;
