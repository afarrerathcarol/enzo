...
int StarParticlePopIII_FlatIMFInitialize(void);
			   ...
			   int TotalStarParticleCountPrevious[])
{
  ...
  // fprintf(stdout, "PopIIIInitialMassFunction:%d", PopIIIInitialMassFunction);
  if (PopIIIInitialMassFunction) {
    if (PopIIIInitialMassFunctionSub == 0) // original Salpeter
      StarParticlePopIII_IMFInitialize();
    else if (PopIIIInitialMassFunctionSub == 1) // Flat
      StarParticlePopIII_FlatIMFInitialize();
    else if (PopIIIInitialMassFunctionSub == 2) // Shingo
      StarParticlePopIII_ShingoIMFInitialize();
  }
