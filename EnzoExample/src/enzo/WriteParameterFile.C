...
int WriteParameterFile(FILE *fptr, TopGridData &MetaData, char *name = NULL)
{
  ...
  fprintf(fptr, "PopIIIInitialMassFunctionSub          = %"ISYM"\n",
  ...
  // fprintf(stderr, "PopIIIStellarFeedbackDistRadius: %d\n", PopIIIStellarFeedbackDistRadius);
  fprintf(fptr, "PopIIIStellarFeedbackDistRadius       = %"ISYM"\n", 
          PopIIIStellarFeedbackDistRadius);
  fprintf(fptr, "PopIIIStellarFeedbackDistCellStep     = %"ISYM"\n\n",
          PopIIIStellarFeedbackDistCellStep);
  fprintf(fptr, "PopIIISimpleSupernovaDistRadius       = %"ISYM"\n", 
          PopIIISimpleSupernovaDistRadius);
  fprintf(fptr, "PopIIISimpleSupernovaDistCellStep       = %"ISYM"\n", 
          PopIIISimpleSupernovaDistCellStep);
  fprintf(fptr, "PopIIIEnergyToThermalFeedback       = %"GSYM"\n", 
          PopIIIEnergyToThermalFeedback);
  fprintf(fptr, "PopIIIMakerMassEfficiency       = %"GSYM"\n", 
