...
SPEXTERN int   PopIIIInitialMassFunctionSub;
...
SPEXTERN int   PopIIIStellarFeedbackDistRadius;
SPEXTERN int   PopIIIStellarFeedbackDistCellStep;
SPEXTERN int   PopIIIStellarFeedbackDistTotalCells;
SPEXTERN int   PopIIISimpleSupernovaDistRadius;
SPEXTERN int   PopIIISimpleSupernovaDistCellStep;
SPEXTERN int   PopIIISimpleSupernovaDistTotalCells;
SPEXTERN float PopIIIEnergyToThermalFeedback;
SPEXTERN float PopIIIMakerMassEfficiency;
