...
#define MAX_BUBBLES 100
  ...
  int CollapseTestInitializeGrid(
           int   NumberOfSpheres,
           ...
           int   MetallicityDistributionCase[MAX_SPHERES],
           int   NumberOfBubbles[MAX_SPHERES],
           float BubbleVelocity[MAX_SPHERES][MAX_BUBBLES][MAX_DIMENSION],
           float BubbleDensity[MAX_SPHERES][MAX_BUBBLES]);
